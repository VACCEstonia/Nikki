...
CNL_TEST = 'TEST_CHANNEL_ID'
CNL_REQUESTS = 'REQUESTS_CHANNEL_ID'
CNL_ESTVACC = 'PUBLIC_CHANNEL_ID'
CNL_NIKKI = 'BOT_CHANNEL_ID'

I_AM_NIKKI = 'TxYZhUMP0CsW0pgdGReOSBsrdpHllMiQ'
